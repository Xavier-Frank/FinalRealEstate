...
import com.jeunice.realestate.dao.DepositRepository;
import com.jeunice.realestate.dao.TransactionRequestRepository;
import com.jeunice.realestate.models.Deposit;
import com.jeunice.realestate.models.PayRequest;
...
public class DepositController {
    ...
    public Map<String, Object> makePayment(@Validated @RequestBody PayRequest payRequest) {
        ...
        Map<String, Object> mappedResponse = ((org.springframework.boot.json.JsonParser) parser).parseMap(json);
    ...
    public Map<String, Object> checkTransaction(@PathVariable(value = "checkout_id") String checkout_id) {
        Optional<Transaction> transaction = transactionRequestRepository.getTransactionsByCheckoutRequestID(checkout_id);
...
//
    public String getToken() {
        ...
        String json = responseEntity.getBody();
        JsonParser parser = (JsonParser) JsonParserFactory.getJsonParser();
        Map<String, Object> map = ((org.springframework.boot.json.JsonParser) parser).parseMap(json);
