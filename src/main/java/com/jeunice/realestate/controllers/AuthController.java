...
import com.jeunice.realestate.services.EmailServiceImplementation;
...
public class AuthController {
    ...
    public ModelAndView processForgotPasswordPage(ModelAndView modelAndView, @RequestParam("email") String userEmail,
        ...
        if (optional.isPresent()){
            ...
            //send the email
            emailServiceImplementation.sendEmail(passwordResetEmail);
...
//            modelAndView.addObject("errorMessage", "Email accout")
    ...
    public ModelAndView displayResetPasswordPage(ModelAndView modelAndView, @RequestParam("token") String token){
        Optional<Tenants> user1 = tenantsServiceImplementation.findUserByResetToken(token);
    ...
    public ModelAndView setNewPassword(ModelAndView modelAndView, @RequestParam Map<String, String> requestParams,
        ...
        Optional<Tenants> user1 = tenantsServiceImplementation.findUserByResetToken(requestParams.get("token"));
        ...
        if (user1.isPresent()){
            ...
            //saving the user
            tenantsServiceImplementation.saveTenant(resetUser);
